...
import com.yuantu.dev.common.YuantuConstant;
import com.yuantu.dev.common.utils.JacksonUtils;
import com.yuantu.dev.common.utils.RegexUtils;
import com.yuantu.dev.sys.controller.DrawController;
import com.yuantu.dev.sys.dto.*;
import com.yuantu.dev.sys.entity.*;
import com.yuantu.dev.sys.mapper.UserMapper;
import com.yuantu.dev.sys.service.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public User loginByDto(HttpServletRequest request, HttpServletResponse response, LoginDTO dto) {
        ...
        // 返回临时对象页面显示
        User tempUser = baseMapper.queryUserIndexPage(user.getId());
    ...
    public boolean resetPassword(Long id) {
        ...
        String password = (sysDefaultPassword != null ? sysDefaultPassword.getContent() : YuantuConstant.DEFAULT_PASSWORD);
        User temp = new User();
        temp.setId(id);

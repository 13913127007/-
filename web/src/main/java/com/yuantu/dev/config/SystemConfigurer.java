...
import com.yuantu.dev.common.LoginHandlerInterceptor;
import com.baomidou.kisso.web.interceptor.SSOSpringInterceptor;
import com.yuantu.dev.common.YuantuConfigurer;
...
@ControllerAdvice
@Configuration
public class SystemConfigurer extends YuantuConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(ssoInterceptor)
                .addPathPatterns("/**")
                .excludePathPatterns("/sso/**", "/alipay/**", "/resource/nav_menu", "/static/file/**", "/wx/miniapp/**");
...
//        registry.addInterceptor(new LogInterceptor());
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("http://106.14.63.23:8080");

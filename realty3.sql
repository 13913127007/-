...
-- ----------------------------
INSERT INTO `company_customer` VALUES ('5', '小明', 'zjh', '1222', '男', '15236230225', '7');
INSERT INTO `company_customer` VALUES ('6', '小耿', 'ldh', '123456', '男', '15236230225', '7');
...
INSERT INTO `company_customer` VALUES ('46', '张家辉', 'zjh', '123456', '男', '15236230225', '7');
INSERT INTO `company_customer` VALUES ('47', '张家辉', 'zjh', '123456', '男', '15236230225', '7');
INSERT INTO `company_customer` VALUES ('48', '张家辉', 'zjh', '123456', '男', '15236230225', '7');
INSERT INTO `company_customer` VALUES ('49', '张家辉', 'zjh', '123456', '男', '15236230225', '7');
INSERT INTO `company_customer` VALUES ('50', '张家辉', 'zjh', '123456', '男', '15236230225', '7');
INSERT INTO `company_customer` VALUES ('51', '张家辉', 'zjh', '123456', '男', '15236230225', '7');
INSERT INTO `company_customer` VALUES ('62', '成龙', 'cl', '123456', '男', '15236230225', '7');
INSERT INTO `company_customer` VALUES ('63', '成龙', 'cl', '123456', '女', '15236230225', '7');
...
-- ----------------------------
INSERT INTO `company_info` VALUES ('7', '龙腾集团', 'ghhjjxxxxxxx', '12.00', '0', '0', 'admin', '2019-11-05 16:20:14', '2019-11-05 16:20:14', '0');
INSERT INTO `company_info` VALUES ('8', '阿狸集团', 'fdg', '10.00', '0', '0', 'admin', '2019-11-06 09:26:31', '2019-11-06 09:26:31', '0');
...
CREATE TABLE `product_detail` (
  ...
  `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '状态(-1:禁用；0:正常)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品明细表';
...
CREATE TABLE `product_type` (
  ...
  `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '状态(-1:禁用；0:正常)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品类型表';
...
CREATE TABLE `product_unit` (
  ...
  `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '状态(-1:禁用；0:正常)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品单位表';
...
CREATE TABLE `property_value_type` (
  ...
  `modified_time` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品特殊加价类型表';
...
CREATE TABLE `sys_log` (
  ...
  `create_time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统_日志表';
...
CREATE TABLE `sys_resource` (
  ...
  `modified_time` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统_资源表';
...
INSERT INTO `sys_resource` VALUES ('46', '45', '企业管理', 'qygl', '0', '', '#company-company', 'business/building/company.html', 'layui-icon-diamond', '0', '0', '0', 'admin', '2019-11-12 15:09:14', '2019-11-12 15:09:14');
INSERT INTO `sys_resource` VALUES ('47', '45', '人员管理', 'rygl', '0', '', 'javascript:;', '', 'layui-icon-user', '0', '0', '0', 'admin', '2019-11-12 15:12:15', '2019-11-12 15:12:15');
INSERT INTO `sys_resource` VALUES ('48', '47', '物业人员', 'wyry', '0', '', '#property_personnel', 'property/property_personnel.html', 'layui-icon-username', '0', '0', '0', 'admin', '2019-11-12 15:13:43', '2019-11-12 15:13:43');
...
) ENGINE=InnoDB AUTO_INCREMENT=643 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统_角色资源关联表';

-- ----------------------------
-- Records of sys_role_resource
-- ----------------------------
INSERT INTO `sys_role_resource` VALUES ('622', '1', '10');
INSERT INTO `sys_role_resource` VALUES ('623', '1', '21');
INSERT INTO `sys_role_resource` VALUES ('624', '1', '8');
INSERT INTO `sys_role_resource` VALUES ('625', '1', '7');
INSERT INTO `sys_role_resource` VALUES ('626', '1', '9');
INSERT INTO `sys_role_resource` VALUES ('627', '1', '3');
INSERT INTO `sys_role_resource` VALUES ('628', '1', '11');
INSERT INTO `sys_role_resource` VALUES ('629', '1', '6');
INSERT INTO `sys_role_resource` VALUES ('630', '1', '5');
INSERT INTO `sys_role_resource` VALUES ('631', '1', '4');
INSERT INTO `sys_role_resource` VALUES ('632', '1', '12');
INSERT INTO `sys_role_resource` VALUES ('633', '1', '13');
INSERT INTO `sys_role_resource` VALUES ('634', '1', '42');
INSERT INTO `sys_role_resource` VALUES ('635', '1', '44');
INSERT INTO `sys_role_resource` VALUES ('636', '1', '43');
INSERT INTO `sys_role_resource` VALUES ('637', '1', '41');
INSERT INTO `sys_role_resource` VALUES ('638', '1', '45');
INSERT INTO `sys_role_resource` VALUES ('639', '1', '47');
INSERT INTO `sys_role_resource` VALUES ('640', '1', '48');
INSERT INTO `sys_role_resource` VALUES ('641', '1', '49');
INSERT INTO `sys_role_resource` VALUES ('642', '1', '46');
